...
public class BaseClass {
	...
	//Taking screenshot
	public static void screenShotCapture(String filename, String location) throws IOException {
		TakesScreenshot tk = (TakesScreenshot) driver;
		File from = tk.getScreenshotAs(OutputType.FILE);
		File to = new File(location+"\\"+filename+"_"+new Date().getTime()+".jpg");
		//FileUtils.copyFile(from, to);
	}
	
	//workbook
	/*public static String getExcel(String filename, String sheetname, int row, int col)throws IOException {
	
		File file = new File("D:\\Sujatha\\Selenium Testing\\Selenium Testing Course - Green Technology - sep 2022\\eclipse-selenium-workspace\\MavenProj\\src\\main\\resources\\"+filename+".xlsx");
